...
ANALYSIS_MESSAGE_LIBRARY = {
    "neg_low": {
        "high": "[우울/무기력 점수가 높아요!] 평소보다 훨씬 많이 우울해 보여요. 지금 바로 기분 전환이 필요해요!",
        "mid": "[우울/무기력 수치가 상승했어요!] 조금 지쳐 보이는군요. 잠시 쉬어가도 괜찮아요.",
        "low": "[우울/무기력이 조금 있어요!] 마음이 조금 가라앉아 있네요. 무슨 일 있었나요?"
    },
    "neg_high": {
        "high": "[불안/분노 점수가 높아요!] 마음속에 큰 폭풍이 몰아치는 것 같아요. 제가 옆에 있을게요.",
        "mid": "[불안/분노 수치가 상승했어요!] 조금 예민하고 날카로워진 것 같아요. 잠시 심호흡을 해볼까요?",
        "low": "[불안/분노가 조금 있어요!] 약간의 불안감이 느껴져요. 무엇이 당신을 불편하게 하나요?"
    },
    "adhd_high": {
        "high": "[주의 집중이 많이 어려운 상황이네요!] 생각이 많아 집중이 어려운 상태인 것 같아요. 하나씩 차근차근 해봐요.",
        "mid": "[주의 집중력이 저하되었어요!] 주의가 조금 흩어져 있네요. 잠시 주변을 정리해보는 건 어때요?",
        "low": "[주의 집중이 좀 어려운 상황이네요!] 마음이 살짝 붕 떠 있는 느낌이 들어요."
    },
    "sleep": {
        "high": "[수면 불편 점수가 매우 높아요!] 많이 피곤해 보여요. 오늘은 꼭 숙면을 취할 수 있기를 바라요.",
        "mid": "[수면 불편 점수가 저하되었어요!] 어젯밤 잠을 설친 것 같군요. 괜찮아요?",
        "low": "[수면 문제가 있어요!] 조금 졸려 보이네요. 편안한 밤을 보냈나요?"
    },
    "positive": {
        "high": "[행복지수가 높아요!] 정말 좋은 일이 있었나 봐요! 얼굴에 웃음꽃이 피었어요. 😊",
