...
// Bottom Navigation
  ...
  // Nudge Modal
  static const String checkYourEmotion =
      '요즘 마음이 어떤지,\n내 감정 상태를 알아보세요!';
  static const String findMyEmotion = '나의 감정 알아보러 가기';
  static const String snooze7Day = '7일간 보지 않기';
  ...
  static const String passwordErrorMessage =
      '암호가 일치하지 않아요. 다시 시도해 주세요';
  static const String passwordGuide = '암호를 입력해 주세요';
  static const String newPasswordGuide = '새로운 암호를 입력해 주세요';
  static const String reCheckNewPasswordGuid =
      '새로운 암호를 한 번 더 입력해 주세요';
