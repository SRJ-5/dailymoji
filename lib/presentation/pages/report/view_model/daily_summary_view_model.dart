...
class DailySummaryViewModel extends Notifier<DailySummaryState> {
  ...
  Future<List<DailySummary>> getMonthDatas(
      String userId, DateTime focusedDate) async {
    final monthDatas = await ref.read(dailySummaryUsecaseProvider).execute(
          userId: userId,
    ...
    print("aaaaaaaaaaaaaaaaaaa${monthDatas.length}");
    return monthDatas;
  }
}
