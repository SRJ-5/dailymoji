...
// Rin: enterChatRoom방식: 홈에서 들어갈때 이 부분 충돌안나게 주의하기
  ...
  void _scrollToBottomWithRetry(int attemptCount,
      ...
      Future.delayed(const Duration(milliseconds: 50), () {
        if (mounted) {
          _scrollToBottomWithRetry(
              attemptCount + 1, previousMaxExtent);
        }
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen(
        chatViewModelProvider.select((value) => value.isLoading),
        (previous, next) {
            ...
            children: [
              CircleAvatar(
                ...
                backgroundImage: (characterImageUrl != null &&
                    ...
                    : AssetImage(AppImages.characterListFace[
                        seletedCharacterNum!]) as ImageProvider,
              ),
              SizedBox(width: 12.r),
              AppText(
                characterName,
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: AppColors.yellow200, width: 2),
            ),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
      ...
      builder: (context, isKeyboardVisible) {
        return Container(
          ...
          margin: EdgeInsets.only(
              bottom: isKeyboardVisible ? 0 : 34.h),
          child: Container(
            decoration: BoxDecoration(
