...
CLUSTER_KEYWORDS = {
    "neg_low": ["우울", "무기력", "번아웃"],
    "neg_high": ["불안", "분노", "공포", "짜증"],
    "adhd_high": ["ADHD", "산만", "집중", "충동"],
    "sleep": ["수면", "잠"],
    "positive": ["행복", "좋아", "즐거움"],
}
...
# 일반 lexicon
LEXICON = {
    "neg_high": ["불안", "초조", "긴장", "걱정", "공포", "무섭", "두렵", "공황", "짜증", "분노"],
    "neg_low": ["우울", "무기력", "피곤", "지침", "탈진", "소진", "번아웃", "의욕 없", "재미없", "무의미"],
    "adhd_high": ["산만", "집중", "딴짓", "미루", "충동", "정리", "실수"],
    "sleep": ["잠", "불면", "깨", "뒤척", "과다수면", "졸리", "수면제", "졸려", "피곤"],
    "positive": ["감사", "행복", "기쁨", "편안", "자신", "회복"],
}
